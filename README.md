...
Put the API behind a TLS reverse proxy, keep MySQL/Redis on the private Docker network, configure a real SMTP account, and back up the MySQL volume daily before exposing the API to iOS devices.
